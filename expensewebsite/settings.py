...
SECRET_KEY = 'django-insecure-o68rnvw+_o$g8xeotz4tnittg7&selcp7to1($=%hfu+zva!ei'
...
DATABASES = {
    'default': {
        ...
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.getenv("DB_NAME", "incomeexpensedb"),
        "USER": os.getenv("DB_USER", "postgres"),
        "PASSWORD": os.getenv("DB_USER_PASSWORD", "database@123"),
